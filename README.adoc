...
| Guest lecture on SE + link:sessions/session_09/README_PROJECT.md[Add sending of cheeps, and API & UI tests]
...
| Guest lecture on GDPR and "Privacy by Design" link:sessions/session_12/Slides.md[Ethics in Software Engineering, documentation, and visual languages for design and architecture]
