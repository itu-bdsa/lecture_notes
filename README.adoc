...
a| * link:sessions/session_10/Slides.md[Security of web applications]
   * link:https://ituniversity.sharepoint.com/:v:/r/sites/2024AnalysisDesignandSoftwareArchitecture-TA/Shared%20Documents/TA/Adrian%20Video%20Lectures/Session10.mp4?csf=1&web=1&e=UExPFC[Video lecture]
   * link:[Feedback, Git Concepts and Usage] (**13:00** Aud. 1)
