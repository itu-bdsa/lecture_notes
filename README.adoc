...
Refactor _Chirp!_ to support user login via GitHub and sending of cheeps
| link:https://livebook.manning.com/book/asp-net-core-in-action-third-edition/chapter-23?origin=product-toc[23], link:https://livebook.manning.com/book/asp-net-core-in-action-third-edition/chapter-24?origin=product-toc[24]
Identity Server, Authentication and Authorization, and OAuth
...
| link:sessions/session_10/README_PROJECT.md[Add (un-)follow feature, harden and secure _Chirp!_]
