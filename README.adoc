...
a| * link:sessions/session_06/Slides.md[Intro to EF Core with SQLite, LINQ, and Repository pattern]
   ...
   * link:sessions/session_06/Feedback.md[Feedback] (**13:15** Aud. 1)
...
a| * Guest lecture on Software Licenses (**10:50** Aud. 1)
   ...
   * Feedback, Deploying to Azure (**12:45** Aud. 1)
...
a| * link:sessions/session_08/README_PROJECT.md[Add login with GitHub to _Chirp!_]
   * link:https://ituniversity.sharepoint.com/:v:/r/sites/2024AnalysisDesignandSoftwareArchitecture/Shared%20Documents/General/Recordings/Session08.mp4?csf=1&web=1&e=WKne8t[Video lecture]
   * *Project Review 2 (23/10)*
...
a| * Guest lecture on Software Engineering@Netcompany (**10:00** Aud. 1)
   * link:sessions/session_09/Slides.md[Forms and UI Testing]
   * link:sessions/session_09/Feedback.md[Feedback] (**11:15** Aud. 1)
   * link:https://ituniversity.sharepoint.com/:v:/r/sites/2024AnalysisDesignandSoftwareArchitecture/Shared%20Documents/General/Recordings/Session09.mp4?csf=1&web=1&e=rxqNJ3[Video lecture]
| link:sessions/session_09/README_PROJECT.md[Add sending of cheeps, and UI tests]
...
a| * link:sessions/session_10/Slides.md[Security of web applications]
   * link:https://ituniversity.sharepoint.com/:v:/r/sites/2024AnalysisDesignandSoftwareArchitecture/Shared%20Documents/General/Recordings/Session10.mp4?csf=1&web=1&e=Kb2h1l[Video lecture]
   * link:sessions/session_10/Git_Crash_Course_by_daso.pdf[Feedback, Git Concepts and Usage] (**13:00** Aud. 1)
...
| link:sessions/session_11/README_PROJECT.md[Add (un-)follow feature, fix _Chirp!_ users]
|
|12
|47
|20/11/2024
...
| [line-through]#link:sessions/session_13/Slides.md[Reflection on design and architecture & wrap-up]#
| link:sessions/session_13/README_PROJECT.md[Wild style, implement your own features to _Chirp!_, Refactoring design]
|
