...
## Project Demo Day(s) Presentations

5-minute presentation focusing on your custom Chirp! feature
...
Inspiration for providing peer-feedback to the presentations of your fellow groups.
...
- Visualizations:
  ...
  - Are relation ends on the correct side of relations? Are multiplicities correct?
  - Are the correct diagram types used?
  - Are there separate illustrations of structure and behaviour or are they mixed?
...
- See the description of the deliverable [here](../session_12/README_REPORT.md)
- Find the template for the report [here](../session_12/docs/)
...
* Design and Architecture of _Chirp!_
  ...
  * User activities, Sequence of functionality/calls
...
* Process
  ...
  * How to run and test _Chirp!_ locally
...
**How does it relate to Fioralba's lecture?**, Session 10: Modern SE in today’s data-driven world. *What to know before you touch a line of code*
 ...
 *![w:750](https://i5.walmartimages.com/asr/83c4fe30-b5d1-491f-a0a9-13e87442c103.12f237b8fc2e4cb20c2f44145d714c2b.jpeg)
...
Online advertising consumed between 20.38 to 282.75 TWh of energy and 11.53 – 159.93 million tons of CO2e was emitted to produce the electricity consumed [in 2016].
...
![w:900](https://blog.inedo.com/wp-content/uploads/2025/07/image-5-1536x864.png)

&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;*Image source: <a href="https://blog.inedo.com/dotnet/demystifying-lts">inedo blog</a>*
...
-->
  ...
  > Don’t let your code base fall behind its dependencies. Check for updates at a regular schedule. It’s easy to forget, but if you fall too far behind, it could be difficult to catch up.
...
For example, what happens when Microsoft changes their pricing models?
  ...
  > Danske myndigheder er blevet dybt afhængige af amerikanske techgiganter, der bliver ved med at sætte priserne på licenserne op og dermed lænser de offentlige pengekasser. I Region Hovedstaden har det allerede kostet 150 stillinger.
...
> _[View] Home timeline_ A user can view tweets posted by the people they follow (300k requests/sec).
...
* Elective _DevOps, Software Evolution and Software Maintenance_ in spring 2026
...
https://learnit.itu.dk/mod/questionnaire/view.php?id=235590
##
